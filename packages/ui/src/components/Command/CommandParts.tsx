...
function CommandDialog({
  ...
  return (
    <DialogRoot {...props}>
      ...
      <DialogContent className={cn('overflow-hidden p-0 border-none', className)} showCloseButton={showCloseButton}>
...
function CommandEmpty({ ...props }: React.ComponentProps<typeof CommandPrimitive.Empty>) {
  return (
    <CommandPrimitive.Empty data-slot="command-empty" className="py-6 text-center text-juiText-secondary" {...props} />
  );
}
