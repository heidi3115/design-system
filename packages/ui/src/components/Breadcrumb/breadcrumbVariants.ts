  ...
  variants: {
    ...
    size: {
      small: {
        ...
        wrapper: '',
        list: 'gap-1.5',
        listItem: 'gap-1.5 text-sm',
        link: '[&:has(svg)]:gap-1.5',
      ...
      medium: {
        ...
        wrapper: '',
        list: 'gap-2.5 ',
        listItem: 'gap-2.5 text-base',
        link: '[&:has(svg)]:gap-2.5 [&_svg]:size-4',
        page: '[&:has(svg)]:gap-2.5 [&_svg]:size-4',
      ...
      large: {
        ...
        wrapper: '',
        list: 'gap-3.5',
        listItem: 'gap-3.5 text-lg',
        link: '[&:has(svg)]:gap-3.5 [&_svg]:size-5',
        page: '[&:has(svg)]:gap-3.5 [&_svg]:size-5',
        separator: '[&>svg]:size-8',
        ellipsis: 'size-8',
      },
      custom: {
