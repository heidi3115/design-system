...
const meta: Meta<typeof Badge> = {
  ...
  argTypes: {
    ...
    status: {
      ...
      description:
        'Badge의 상태를 지정하는 props로서 variant가 state인 경우에 사용됩니다. 상세 내역은 State 스토리를 참조해주세요.',
    },
    score: {
      control: 'select',
      options: scoreArr,
      ...
      description:
        'Badge의 점수 스타일을 지정하는 props로서 variant가 scoring인 경우에 사용됩니다. 상세 내역은 Scoring 스토리를 참조해주세요.',
    },
    grade: {
      control: 'select',
      options: gradeArr,
      ...
      description:
        'Badge의 등급 스타일을 지정하는 props로서 variant가 grading인 경우에 사용됩니다. 상세 내역은 Grade 스토리를 참조해주세요.',
    },
    className: {
      control: 'text',
    ...
    docs: {
      description: {
        component: [
          ...
          '공통적으로 적용되는 Badge의 스타일은 inline-flex로서 size-fit을 기본으로 합니다.',
        ].join('<br/>'),
      },
    },
  },
